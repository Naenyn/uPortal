...
/**
 * A {@link jakarta.servlet.Filter} that enable client-side cross-origin requests by implementing
...
public class CorsFilter implements Filter {
    ...
    /** {@link jakarta.servlet.FilterConfig} reference to {@code init()} parameter. */
